...
class SequentialRunner(
    ...
    def _prepare(
        ...
        if isinstance(runner.executor, WithProgress):
    ...
    #     self._executor_task = self.progress.add_task(
    #         description="",
    #         total=0,
    #         completed=0,
    #         parent_task=self._task,  # Enable hierarchy
    #         is_last_subtask=True,  # Pipeline is the only node under runner
    ...
    #         self.executor.shared_task = self._executor_task
